...
@implementation AppDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "SmartSchedule.AppDelegate, SmartSchedule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", ".ctor");
	}
@end

@interface SmartSchedule_RootViewController : UIViewController {
	void *__monoObjectGCHandle;
}
	-(void) release;
	-(id) retain;
	...
	-(id) init;
@end
@implementation SmartSchedule_RootViewController { } 
	-(void) release
	{
		monotouch_release_trampoline (self, _cmd);
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, "SmartSchedule.RootViewController, SmartSchedule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidLoad");
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "SmartSchedule.RootViewController, SmartSchedule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", ".ctor");
	}
@end

@interface SmartSchedule_CalendarView : UIView {
	void *__monoObjectGCHandle;
}
	-(void) release;
	-(id) retain;
	...
	-(bool) conformsToProtocol:(void *)p0;
@end
@implementation SmartSchedule_CalendarView { } 
	-(void) release
	{
		monotouch_release_trampoline (self, _cmd);
	}
...
@end
	...
	static MTClassMap __monotouch_class_map [] = {
		...
		{"AppDelegate", "SmartSchedule.AppDelegate, SmartSchedule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", NULL },
		...
		{"SmartSchedule_RootViewController", "SmartSchedule.RootViewController, SmartSchedule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", NULL },
		{"UIView", "MonoTouch.UIKit.UIView, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", NULL },
		{"SmartSchedule_CalendarView", "SmartSchedule.CalendarView, SmartSchedule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", NULL },
...
void monotouch_create_classes () {
	...
	__monotouch_class_map [4].handle = [SmartSchedule_RootViewController class];
	__monotouch_class_map [5].handle = objc_getClass ("UIView");
	__monotouch_class_map [6].handle = [SmartSchedule_CalendarView class];
	__monotouch_class_map [7].handle = objc_getClass ("NSArray");
	__monotouch_class_map [8].handle = objc_getClass ("NSCalendar");
	__monotouch_class_map [9].handle = objc_getClass ("NSDate");
	...
	__monotouch_class_map [14].handle = objc_getClass ("UIButton");
	__monotouch_class_map [15].handle = objc_getClass ("MonoTouch_UIKit_UIControlEventProxy");
	__monotouch_class_map [16].handle = objc_getClass ("UIDevice");
	__monotouch_class_map [17].handle = objc_getClass ("UIFont");
	__monotouch_class_map [18].handle = objc_getClass ("UINavigationController");
	__monotouch_class_map [19].handle = objc_getClass ("UIScreen");
	__monotouch_class_map [20].handle = objc_getClass ("UIWindow");
	__monotouch_class_map [21].handle = objc_getClass ("UILabel");
	__monotouch_class_map [22].handle = objc_getClass ("UITraitCollection");
	__monotouch_class_map [23].handle = objc_getClass ("NSDateComponents");
	__monotouch_class_map [24].handle = objc_getClass ("NSException");
	__monotouch_class_map [25].handle = objc_getClass ("NSDictionary");
	__monotouch_class_map [26].handle = objc_getClass ("__NSObject_Disposer");
	monotouch_setup_classmap (__monotouch_class_map, 27);
}
